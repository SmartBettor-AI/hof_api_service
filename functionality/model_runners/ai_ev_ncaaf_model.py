...
class DataLoaderMaker():
  ...
  def load_scaler(self):
     with open(f"models/scalers/ncaaf_pregame_scaler.pkl", 'rb') as file:
      return pickle.load(file)
     
   
  def load_encoder(self):
     with open(f"models/encoders/ncaaf_pregame_encoder.pkl", 'rb') as file:
      return pickle.load(file)


  def standardize_numerical_values(self, df):

        categorical_columns = ['home_team', 'away_team', 'day_of_week', 'hour_of_start', 'day_or_night', 'market_key', 'outcome_type']

        numerical_columns = ['betrivers_1_odds', 'fanduel_1_odds', 'betmgm_1_odds', 'draftkings_1_odds', 'williamhill_us_1_odds', 'bovada_1_odds', 'pointsbetus_1_odds', 'betonlineag_1_odds', 'ev', 'std_dev', 'ev_additive', 'highest_bettable_odds', 'average_market_odds_old', 'minutes_since_commence']
...
class NCAAFRunner():
    ...
    def final_format(self, df):
        ...
        df['sport_title'] = 'americanfootball_ncaaf'
    ...
    def run(self):
      ...
      df = df[df['sport_title'] == 'americanfootball_ncaaf']
      ...
      self.write_to_cache(df, 'ncaaf_ai_ev_pregame_cache')
...
if __name__ == "__main__":
    ...
    runner = NCAAFRunner(name = 'CFB_08_27_2024_model_relu_profit_100e_32_1e-05lr_Falsewd_500mb', live_or_pregame='pregame', sport='CFB')
