...
class DataLoaderMaker():
  ...
  def load_scaler(self):
     with open(f"models/scalers/nfl_pregame_scaler.pkl", 'rb') as file:
      return pickle.load(file)
     
   
  def load_encoder(self):
     with open(f"models/encoders/nfl_pregame_encoder.pkl", 'rb') as file:
      return pickle.load(file)
...
class NFLRunner():
    ...
    def final_format(self, df):
        ...
        df['sport_title'] = 'americanfootball_nfl'
    ...
    def run(self):
      ...
      df = df[df['sport_title'] == 'americanfootball_nfl']
      ...
      self.write_to_cache(df, 'nfl_ai_ev_pregame_cache')
...
if __name__ == "__main__":
    ...
    runner = NFLRunner(name = 'NFL_08_28_2024_model_relu_profit_100e_2048_1e-05lr_Falsewd_500mb', live_or_pregame='pregame', sport='NFL')
